...
Kruschke discussed how we'd need $z = 1200$ and $N = 2400$ before the posterior HDIs would fit within a narrow ROPE like 0.48 and 0.52. Here's what that would look like based on the priors from Figure 12.4.
...
```{=latex}
\begin{align*}
n _{{\rm recalled}, ij} & \sim \operatorname{Binomial} \left( n = 20, \theta _{j} \right), \text{ where} \\
